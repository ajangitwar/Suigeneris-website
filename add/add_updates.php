	...
	<center>
		<div class="card">
			<form method="post" action="add_updates.php">
				<br>
				<h5>Add New Events Here!!</h5>
				<input type="text" name="title" placeholder="Title" style="margin-top: 5px" required /><br>
				<input type="textarea" name="discription" placeholder="Discription" style="margin-top: 5px" required /><br>
				<button type="submit" class="btn tn-primary" name="submit" style="margin-bottom: 15px;margin-top:15px">Add Update</button>
			</form>
