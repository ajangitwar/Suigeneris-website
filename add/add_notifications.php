...
<body>
	...
	<center>
		<div class="card">
			<form method="post" action="add_notifications.php">
				<br>
				<h5>Add New Notifications Here!!</h5>
				...
				<button type="submit" class="btn tn-primary" name="submit" style="margin-bottom: 15px;margin-top:15px">Add Notification</button>
			</form>

			<?php

			add_notifications($connect);
