...
<html>
<head>
  <title>Media and Documentation</title>
  <meta charset="utf-8">
...
<body>
 <div class="card bg-dark text-white">
    <div class="card-body"><center><h1>Media and Documentation</h1></center></div>
  </div>
  <div class="container">
      
<?php

  $get = mysqli_query($connect, "SELECT * from media_documentation");
