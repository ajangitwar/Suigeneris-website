...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../css/membercard.css">
    <link rel="stylesheet" type="text/scss" href="../css/_card.scss">
...
<body>
 <div class="card bg-dark text-white">
    <div class="card-body"><center><h1>Technical</h1></center></div>
  </div>
	<div class="container">
			
<?php

	$get = mysqli_query($connect, "SELECT * from technical");
